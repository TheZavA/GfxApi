...
module_ptr_t handle_y3d(noisepp::Pipeline3D& pipeline,
                             ...
                             const child_modules_t& child_modules)
{
    check_name_and_size("y-module", element, child_modules,0);

    std::auto_ptr<noisepp::YModule> module_ptr( new noisepp::YModule() );

    noisepp::YModule& module = *module_ptr;
...
module_ptr_t handle_multiply3d(noisepp::Pipeline3D& pipeline,
                               const tinyxml2::XMLElement& element,
                               const child_modules_t& child_modules)
{
...
{
    handlers["perlin"] = boost::bind(handle_perlin3d, _1, _2, _3);
    handlers["billow"] = boost::bind(handle_billow3d, _1, _2, _3);
    handlers["voronoi"] = boost::bind(handle_voronoi3d, _1, _2, _3);
    handlers["ridged-multi"] = boost::bind(handle_ridged_multi3d, _1, _2, _3);

    handlers["clamp"] = boost::bind(handle_clamp3d, _1, _2, _3);

    handlers["y-module"] = boost::bind(handle_y3d, _1, _2, _3);

    handlers["const"] = boost::bind(handle_const3d, _1, _2, _3);
    handlers["invert"] = boost::bind(handle_invert3d, _1, _2, _3);
    handlers["inverse-mul"] = boost::bind(handle_inverse_mul3d, _1, _2, _3);

    handlers["addition"] = boost::bind(handle_addition3d, _1, _2, _3);
    handlers["multiply"] = boost::bind(handle_multiply3d, _1, _2, _3);
    handlers["blend"] = boost::bind(handle_blend3d, _1, _2, _3);
    handlers["select"] = boost::bind(handle_select3d, _1, _2, _3);
